...
public class DetalleClienteDAO {
    ...
    //Inserta un detalle nuevo. IMPORTANTE: el id debe coincidir con un cliente existente (relación 1:1).
    ...
    public void insert(DetalleCliente d, Connection con) throws SQLException {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            String tel = d.getTelefono();
            if (tel == null || tel.isBlank()) {
                ps.setNull(3, Types.VARCHAR);   // Se fuerza NULL > rompe NOT NULL
            } else {
    ...
    //Obtiene un detalle según el ID (clave primaria).Devuelve null si no existe.
    ...
    //Actualiza los datos del detalle.Si id no existe, devuelve 0.
    ...
    // =========================================================================
    //  MAPEO ResultSet → DetalleCliente
    // =========================================================================
